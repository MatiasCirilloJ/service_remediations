    ...
    def run(self, message, id="", idTag="", levelTag="", messageField="", durationField=""):
        ...
        try:
            ...
            if service == "NEP@L_Controller" and value != 0:
                os.system("st2 rule disable service_remediations_pack.service_remediations_rule")
                time.sleep(15)
                os.system("st2 rule enable service_remediations_pack.service_remediations_rule")
